...
namespace engine
{
	...
	bool attach_shadows(World& world, Entity light, LightType light_type, std::optional<math::vec2i> resolution=std::nullopt, std::optional<CameraComponent> perspective_cfg=std::nullopt, bool update_aspect_ratio=true, bool conform_to_light_type=false);
