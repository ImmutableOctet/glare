...
namespace engine
{
	...
	Entity load_model(World& world, const std::string& path, Entity parent=null, EntityType type=EntityType::Geometry, bool attach_collision=false); // const std::string_view&
}