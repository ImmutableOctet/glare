...
TEST_CASE("engine::parse_instruction_header", "[engine:entity]")
{
	...
	{
		auto [instruction, opt_thread_details, thread_accessor_used] = engine::parse_instruction_header(std::string_view("some_thread.thread_local_var = A::B"));
	...
	{
		auto [instruction, opt_thread_details, thread_accessor_used] = engine::parse_instruction_header(std::string_view("some_thread.resume()"));
	...
	SECTION("Thread-qualified yield statement with simplified condition syntax")
	{
		...
		auto [instruction, opt_thread_details, thread_accessor_used] = engine::parse_instruction_header(instruction_raw);
	...
	SECTION("Unintended yield expression")
	{
		...
		auto [instruction, opt_thread_details, thread_accessor_used] = engine::parse_instruction_header(unintended);
